...
func tinyjson223cdf42DecodeDexSdkTinyjsonTmp(in *jlexer.Lexer, out *EnvMap) {
...
func tinyjson223cdf42EncodeDexSdkTinyjsonTmp(out *jwriter.Writer, in EnvMap) {
...
func (v EnvMap) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjson223cdf42EncodeDexSdkTinyjsonTmp(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *EnvMap) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson223cdf42DecodeDexSdkTinyjsonTmp(l, v)
}
func tinyjson223cdf42DecodeDexSdkTinyjsonTmp1(in *jlexer.Lexer, out *Env) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "sender":
			tinyjson223cdf42DecodeDexSdkTinyjsonTmp2(in, &out.Sender)
		case "msg.caller":
...
func tinyjson223cdf42EncodeDexSdkTinyjsonTmp1(out *jwriter.Writer, in Env) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		out.RawString(prefix)
		tinyjson223cdf42EncodeDexSdkTinyjsonTmp2(out, in.Sender)
	}
	{
...
func (v Env) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjson223cdf42EncodeDexSdkTinyjsonTmp1(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Env) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson223cdf42DecodeDexSdkTinyjsonTmp1(l, v)
}
func tinyjson223cdf42DecodeDexSdkTinyjsonTmp3(in *jlexer.Lexer, out *Intent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson223cdf42EncodeDexSdkTinyjsonTmp3(out *jwriter.Writer, in Intent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjson223cdf42DecodeDexSdkTinyjsonTmp2(in *jlexer.Lexer, out *Sender) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson223cdf42EncodeDexSdkTinyjsonTmp2(out *jwriter.Writer, in Sender) {
	out.RawByte('{')
	first := true
	_ = first
	{
