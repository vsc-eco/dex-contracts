...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp(in *jlexer.Lexer, out *SwapResult) {
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp(out *jwriter.Writer, in SwapResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp1(in *jlexer.Lexer, out *SwapParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp1(out *jwriter.Writer, in SwapParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp2(in *jlexer.Lexer, out *RemoveLiquidityParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp2(out *jwriter.Writer, in RemoveLiquidityParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp3(in *jlexer.Lexer, out *PoolInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp3(out *jwriter.Writer, in PoolInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp4(in *jlexer.Lexer, out *InitParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp4(out *jwriter.Writer, in InitParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonBbf8afaeDecodeDexDexInternalTinyjsonTmp5(in *jlexer.Lexer, out *AddLiquidityParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonBbf8afaeEncodeDexDexInternalTinyjsonTmp5(out *jwriter.Writer, in AddLiquidityParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
